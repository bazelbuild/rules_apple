...
| <a id="ios_xctestrun_runner-post_action"></a>post_action |  A binary to run following test execution. Runs after testing but before coverage processing.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
| <a id="ios_xctestrun_runner-pre_action"></a>pre_action |  A binary to run prior to test execution. Runs after simulator creation.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
