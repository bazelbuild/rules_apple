...
ios_xctestrun_runner(<a href="#ios_xctestrun_runner-name">name</a>, <a href="#ios_xctestrun_runner-attachment_lifetime">attachment_lifetime</a>, <a href="#ios_xctestrun_runner-clean_up_simulator_action">clean_up_simulator_action</a>, <a href="#ios_xctestrun_runner-command_line_args">command_line_args</a>,
                     ...
                     <a href="#ios_xctestrun_runner-device_type">device_type</a>, <a href="#ios_xctestrun_runner-export_covered_binaries">export_covered_binaries</a>, <a href="#ios_xctestrun_runner-os_version">os_version</a>, <a href="#ios_xctestrun_runner-post_action">post_action</a>,
                     ...
                     <a href="#ios_xctestrun_runner-screen_capture_format">screen_capture_format</a>, <a href="#ios_xctestrun_runner-test_environment">test_environment</a>, <a href="#ios_xctestrun_runner-xcodebuild_args">xcodebuild_args</a>)
</pre>
...
| <a id="ios_xctestrun_runner-export_covered_binaries"></a>export_covered_binaries |  When true, makes the complete set of binaries under coverage available to test actions through `$TEST_BINARIES_FOR_LLVM_COV` and runfiles when coverage instrumentation is enabled. This does not enable LCOV export; use `collect_code_coverage = False` on the test target to disable LCOV export.   | Boolean | optional |  `False`  |
