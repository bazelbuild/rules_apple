...
| <a id="ios_xctestrun_runner-attachment_lifetime"></a>attachment_lifetime | Sets [attachment lifetime](https://developer.apple.com/documentation/xctest/xctattachment/lifetime) for the xcresult output - `"keepNever"`, `"keepAlways"`, or `"deleteOnSuccess"`.   | String | optional | <code>keepNever</code> |
