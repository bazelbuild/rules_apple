...
visionos_application(<a href="#visionos_application-name">name</a>, <a href="#visionos_application-deps">deps</a>, <a href="#visionos_application-resources">resources</a>, <a href="#visionos_application-additional_linker_inputs">additional_linker_inputs</a>, <a href="#visionos_application-app_icons">app_icons</a>, <a href="#visionos_application-app_intents">app_intents</a>,
                     ...
                     <a href="#visionos_application-platform_type">platform_type</a>, <a href="#visionos_application-provisioning_profile">provisioning_profile</a>, <a href="#visionos_application-settings_bundle">settings_bundle</a>, <a href="#visionos_application-shared_capabilities">shared_capabilities</a>, <a href="#visionos_application-stamp">stamp</a>,
...
| <a id="visionos_application-families"></a>families |  A list of device families supported by this extension. Valid values are `iphone` and `ipad`; at least one must be specified.   | List of strings | optional |  `["reality"]`  |
...
| <a id="visionos_application-settings_bundle"></a>settings_bundle |  A resource bundle (e.g. `apple_bundle_import`) target that contains the files that make up the application's settings bundle. These files will be copied into the root of the final application bundle in a directory named `Settings.bundle`.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
...
| <a id="visionos_dynamic_framework-families"></a>families |  A list of device families supported by this extension. Valid values are `iphone` and `ipad`; at least one must be specified.   | List of strings | optional |  `["reality"]`  |
...
| <a id="visionos_framework-families"></a>families |  A list of device families supported by this extension. Valid values are `iphone` and `ipad`; at least one must be specified.   | List of strings | optional |  `["reality"]`  |
...
| <a id="visionos_static_framework-families"></a>families |  A list of device families supported by this extension. Valid values are `iphone` and `ipad`; at least one must be specified.   | List of strings | optional |  `["reality"]`  |
