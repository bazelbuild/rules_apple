...
<pre>
AppleDsymBundleInfo(<a href="#AppleDsymBundleInfo-dsym_bundles">dsym_bundles</a>)
</pre>
...
| Name  | Description |
| :------------- | :------------- |
| <a id="AppleDsymBundleInfo-dsym_bundles"></a>dsym_bundles |  <code>Depset</code> containing <code>File</code> references to each of the dSYM bundles if any were generated by the rule.    |
