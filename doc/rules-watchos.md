...
| <a id="watchos_application-deps"></a>deps |  A list of targets whose resources will be included in the final application. Since a watchOS application does not contain any code of its own, any code in the dependent libraries will be ignored.   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional | [] |
