...
def _ios_test_bundle_attributes():
  ...
  return merge_dictionaries(
      common_rule_attributes(),
      {
          ...
          "test_host": attr.label(mandatory=True, providers=["apple_bundle"]),
...
def _ios_test_bundle_impl(ctx):
  ...
  bundle_id = ctx.attr.test_host.apple_bundle.bundle_id + "Tests"
  ...
  if bundle_id == ctx.attr.test_host.apple_bundle.bundle_id:
