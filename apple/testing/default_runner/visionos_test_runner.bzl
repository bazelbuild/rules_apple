...
"""Deprecated compatibility macro for the visionOS test runner."""
...
_DEPRECATION_MESSAGE = (
    "visionos_test_runner is deprecated. Use apple_xctestrun_runner instead."
)

def visionos_test_runner(
        name,
        device_type = "",
