...
def _ios_sample_test_runner_impl(ctx):
  """Implementation for the ios_sample_test_runner rule."""
  ctx.template_action(
...
ios_sample_test_runner = rule(
    _ios_sample_test_runner_impl,
    attrs={
        "_test_template": attr.label(
            default=Label("@build_bazel_rules_apple//apple/testing/default_runner:ios_sample_test_runner.template.sh"),
...
"""Sample rule that runs library based ios_unit_tests.
