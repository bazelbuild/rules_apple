...
# TODO(b/328282357): Add support for static library archive avoid_deps, assuming the incoming
# providers referenced from targets in the rule's avoid_deps have been processed to correctly
# account for "owners".
