...
visionos_application = rule_factory.create_apple_bundling_rule(
    implementation = _visionos_application_impl,
    platform_type = "visionos",
    product_type = apple_product_type.application,
    doc = "Builds and bundles a visionOS Application.",
)
visionos_dynamic_framework = rule_factory.create_apple_bundling_rule(
...
visionos_static_framework = rule_factory.create_apple_bundling_rule(
