...
load(
    ...
    _AppleRunfilesInfo = "AppleRunfilesInfo",
    ...
    _MacosFrameworkBundleInfo = "MacosFrameworkBundleInfo",
...
AppleRunfilesInfo = _AppleRunfilesInfo
...
MacosFrameworkBundleInfo = _MacosFrameworkBundleInfo
