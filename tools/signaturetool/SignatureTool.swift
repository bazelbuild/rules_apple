...
/// Entry point for SignatureTool.
///
/// This command line application takes in the required inputs to generate a single Signatures XML
...
struct SignatureTool: AsyncParsableCommand {
  static var configuration = CommandConfiguration(
    ...
    abstract: """
      ...
      """,
    subcommands: [CollectSignatures.self],
    defaultSubcommand: CollectSignatures.self
  )
}
