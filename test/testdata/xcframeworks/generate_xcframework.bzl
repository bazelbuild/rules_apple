...
def _create_xcframework(
    ...
    args.extend([";file", "bazel-out/darwin-fastbuild/bin/test/starlark_tests/targets_under_test/ios/generated_swift_static_xcframework_without_swiftmodule2.xcframework/macos-x86_64/generated_swift_static_xcframework_without_swiftmodule2.a"])
