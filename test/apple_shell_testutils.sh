...
# Usage: create_dump_whole_plist [--suffix SUFFIX] <ipa_label> <plist_path>
#
# Concatenates a target named "dump_whole_plist" to the BUILD file that owns
# `ipa_label`, which dumps a plist into a text file that can be checked using
...
#
# Example:
#     create_whole_dump_plist //app:app.ipa Payload/app.app/Info.plist
#     do_build ios //app:dump_plist
