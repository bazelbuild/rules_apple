...
All requested architectures must be either device or simulator architectures.""",
    ...
    binary_contents_test(
        ...
        cpus = {
            "platforms": ["//buildenv/platforms/apple:ios_arm64e"],
            "ios_multi_cpus": [],
        },
        build_type = "device",
        target_under_test = "//test/starlark_tests/targets_under_test/apple/static_library:example_library_arm_sim_support",
    ...
    binary_contents_test(
        name = "{}_visionos_binary_contents_arm_device_platform_pre_xcode26_test".format(name),
        build_type = "simulator",
    ...
    # the Mach-O load command LC_BUILD_VERSION for an arm64 binary.
    binary_contents_test(
        name = "{}_visionos_binary_contents_arm_simulator_platform_pre_xcode26_test".format(name),
        build_type = "simulator",
        target_under_test = "//test/starlark_tests/targets_under_test/apple/static_library:example_vision_library",
        cpus = {
    ...
    # Test that the output binary is identified as visionOS devive (PLATFORM_VISIONOS) via
    # the Mach-O load command LC_BUILD_VERSION for an arm64 binary.
    binary_contents_test(
        name = "{}_visionos_binary_contents_arm_device_platform_post_xcode26_test".format(name),
        build_type = "simulator",
        target_under_test = "//test/starlark_tests/targets_under_test/apple/static_library:example_vision_library",
        cpus = {
            "visionos_cpus": ["arm64"],
    ...
    # Test that the output binary is identified as visionOS simulator (PLATFORM_VISIONOSSIMULATOR)
    # via the Mach-O load command LC_BUILD_VERSION for an arm64 binary.
    binary_contents_test(
        name = "{}_visionos_binary_contents_arm_simulator_platform_post_xcode26_test".format(name),
        build_type = "simulator",
        target_under_test = "//test/starlark_tests/targets_under_test/apple/static_library:example_vision_library",
        cpus = {
            "visionos_cpus": ["sim_arm64"],
    ...
    binary_contents_test(
        ...
        build_type = "device",
        target_under_test = "//test/starlark_tests/targets_under_test/apple/static_library:example_arm64e_capable_ios_library",
        cpus = {
            "ios_multi_cpus": ["arm64", "arm64e"],
        },
        binary_test_file = "$BINARY",
    ...
    analysis_failure_message_test(
        ...
        target_under_test = "//test/starlark_tests/targets_under_test/apple/static_library:example_ios_library_with_rule_level_disabled_features",
        expected_error = "Attempted to enable the secure feature `trivial_auto_var_init` for the target at `//test/starlark_tests/targets_under_test/apple/static_library:example_ios_library_with_rule_level_disabled_features`",
        tags = [name],
    )
