...
def tvos_application_test_suite(name):
    ...
    analysis_output_group_info_files_test(
        ...
        expected_outputs = [
            ...
            "app_with_fmwk_with_fmwk_provisioned.app.dSYM/Contents/Resources/DWARF/app_with_fmwk_with_fmwk_provisioned_arm64",
            "app_with_fmwk_with_fmwk_provisioned.app.dSYM/Contents/Resources/DWARF/app_with_fmwk_with_fmwk_provisioned_x86_64",
