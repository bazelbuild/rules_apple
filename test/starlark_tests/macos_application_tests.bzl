...
def macos_application_test_suite(name):
    ...
    archive_contents_test(
        ...
        build_type = "device",
        target_under_test = "//test/starlark_tests/targets_under_test/macos:app_with_space_in_bundle_name",
        compilation_mode = "opt",
        contains = [
    ...
    analysis_output_group_info_files_test(
        ...
        target_under_test = "//test/starlark_tests/targets_under_test/macos:app with space in target name",
        output_group_name = "dsyms",
        expected_outputs = [
            "app with space in target name.app.dSYM/Contents/Info.plist",
            "app with space in target name.app.dSYM/Contents/Resources/DWARF/app with space in target name_x86_64",
            "app with space in target name.app.dSYM/Contents/Resources/DWARF/app with space in target name_arm64",
        ],
        tags = [name],
    )
    analysis_output_group_info_dsymutil_bundle_files_test(
        ...
        output_group_name = "dsyms",
        expected_outputs = [
            "app with space in target name.app.dSYM",
        ],
        tags = [name],
    )
    apple_dsym_bundle_info_test(
        ...
        target_under_test = "//test/starlark_tests/targets_under_test/macos:app with space in target name",
        expected_direct_dsyms = [
            "dSYMs/app with space in target name.app.dSYM",
        ],
        expected_transitive_dsyms = [
            "dSYMs/app with space in target name.app.dSYM",
        ],
    ...
    analysis_runfiles_dsym_test(
        ...
        target_under_test = "//test/starlark_tests/targets_under_test/macos:app with space in target name",
        expected_runfiles = [
            "third_party/bazel_rules/rules_apple/test/starlark_tests/targets_under_test/macos/app with space in target name.app.dSYM/Contents/Resources/DWARF/app with space in target name_arm64",
            "third_party/bazel_rules/rules_apple/test/starlark_tests/targets_under_test/macos/app with space in target name.app.dSYM/Contents/Info.plist",
        ],
        tags = [name],
    )
    ...
    analysis_runfiles_dsymutil_bundle_test(
        ...
        target_under_test = "//test/starlark_tests/targets_under_test/macos:app with space in target name",
        expected_runfiles = [
            "third_party/bazel_rules/rules_apple/test/starlark_tests/targets_under_test/macos/app with space in target name.app.dSYM",
        ],
        tags = [name],
    )
