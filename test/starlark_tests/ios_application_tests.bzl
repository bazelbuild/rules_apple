...
All requested architectures must be either device or simulator architectures.""",
    ...
    archive_contents_test(
        name = "{}_swift_embedded_span_compatibility_dylib_thinned_for_device".format(name),
        build_settings = {
            build_settings_labels.disable_swift_stdlib_binary_thinning: "False",
        },
        build_type = "device",
        target_under_test = "//test/starlark_tests/targets_under_test/ios:swift_app_using_span_pre_26",
        cpus = {
        ...
        binary_test_file = "$BUNDLE_ROOT/Frameworks/libswiftCompatibilitySpan.dylib",
    ...
    archive_contents_test(
        name = "{}_swift_support_span_compatibility_dylib_thinned_for_device".format(name),
        build_settings = {
            build_settings_labels.disable_swift_stdlib_binary_thinning: "False",
        },
        build_type = "device",
        ...
        binary_test_file = "$ARCHIVE_ROOT/SwiftSupport/iphoneos/libswiftCompatibilitySpan.dylib",
        binary_test_architecture = "arm64",
        binary_not_contains_architectures = ["arm64e"],
        macho_load_commands_contain = ["cmd LC_BUILD_VERSION", "platform IOS"],
        tags = [
...
""",
    ...
    # Test dSYM binaries and linkmaps from framework embedded via 'resources' are propagated
    ...
    analysis_output_group_info_dsymutil_bundle_files_test(
        ...
        output_group_name = "dsyms",
        expected_outputs = [
            "app_with_fmwks_from_no_srcs_objc_libraries_using_resources.app.dSYM",
            # Frameworks
            "fmwk.framework.dSYM",
            "fmwk_min_os_baseline_with_bundle.framework.dSYM",
            "fmwk_no_version.framework.dSYM",
    ...
    analysis_output_group_info_files_test(
        name = "{}_with_runtime_framework_transitive_linkmaps_in_resources_output_group_info_test".format(name),
        target_under_test = "//test/starlark_tests/targets_under_test/ios:app_with_fmwks_from_no_srcs_objc_libraries_using_resources",
        output_group_name = "linkmaps",
        expected_outputs = [
            "app_with_fmwks_from_no_srcs_objc_libraries_using_resources_arm64.linkmap",
            "app_with_fmwks_from_no_srcs_objc_libraries_using_resources_x86_64.linkmap",
            "fmwk_arm64.linkmap",
            "fmwk_x86_64.linkmap",
            "fmwk_min_os_baseline_with_bundle_arm64.linkmap",
            "fmwk_min_os_baseline_with_bundle_x86_64.linkmap",
