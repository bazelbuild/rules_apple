...
def apple_xcframework_test_suite(name):
    ...
    infoplist_contents_test(
        ...
        expected_values = {
            ...
            "AvailableLibraries:7:LibraryIdentifier": "watchos-arm64_arm64_32",
            "AvailableLibraries:7:LibraryPath": "multiplatform_dynamic_xcframework.framework",
            "AvailableLibraries:7:SupportedArchitectures:0": "arm64",
            "AvailableLibraries:7:SupportedArchitectures:1": "arm64_32",
            "AvailableLibraries:7:SupportedPlatform": "watchos",
            "AvailableLibraries:8:LibraryIdentifier": "watchos-arm64_x86_64-simulator",
            "AvailableLibraries:8:LibraryPath": "multiplatform_dynamic_xcframework.framework",
            "AvailableLibraries:8:SupportedArchitectures:0": "arm64",
            "AvailableLibraries:8:SupportedArchitectures:1": "x86_64",
            "AvailableLibraries:8:SupportedPlatform": "watchos",
            "AvailableLibraries:8:SupportedPlatformVariant": "simulator",
            "CFBundlePackageType": "XFWK",
            "XCFrameworkFormatVersion": "1.0",
        },
        tags = [name],
...
Check the rule definition for each of the dependencies to ensure that they have the same or a superset of matching target environments ("simulator" or "device") and OSes ("ios", "tvos", etc.).""",
    ...
    analysis_failure_message_test(
        ...
        target_under_test = "//test/starlark_tests/targets_under_test/apple:ios_dynamic_lipoed_xcframework_with_disabled_features",
        expected_error = "Attempted to enable the secure feature `trivial_auto_var_init` for the target at `//test/starlark_tests/targets_under_test/apple:ios_dynamic_lipoed_xcframework_with_disabled_features`",
        tags = [name],
    )
