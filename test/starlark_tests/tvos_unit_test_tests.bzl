...
def tvos_unit_test_test_suite(name):
    ...
    # Verify that the transition enables dossier generation for tvOS tests.
    apple_codesigning_dossier_info_provider_test(
        ...
        target_under_test = "//test/starlark_tests/targets_under_test/tvos:unit_test.__internal__.__test_bundle",
        tags = [name],
    )
