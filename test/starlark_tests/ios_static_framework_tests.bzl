...
def ios_static_framework_test_suite(name):
    ...
    archive_contents_test(
        ...
        build_type = "device",
        target_under_test = "//test/starlark_tests/targets_under_test/ios:pointer_authentication_static_fmwk",
        cpus = {
    ...
    analysis_failure_message_test(
        ...
        target_under_test = "//test/starlark_tests/targets_under_test/ios:enhanced_security_static_fmwk_with_rule_level_disabled_features",
        expected_error = "Attempted to enable the secure feature `trivial_auto_var_init` for the target at `//test/starlark_tests/targets_under_test/ios:enhanced_security_static_fmwk_with_rule_level_disabled_features`",
        tags = [name],
    )
    ...
    archive_contents_test(
        ...
        build_type = "device",
        target_under_test = "//test/starlark_tests/targets_under_test/ios:trivial_auto_var_init_static_fmwk",
        cpus = {
            "ios_multi_cpus": ["arm64"],
        },
        binary_test_file = "$BUNDLE_ROOT/trivial_auto_var_init_static_fmwk",
        binary_test_architecture = "arm64",
        macho_load_commands_contain = ["cmd LC_BUILD_VERSION", "platform IOS"],
        tags = [name],
    )
