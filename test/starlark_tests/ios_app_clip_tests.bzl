...
def ios_app_clip_test_suite(name):
    ...
    analysis_output_group_info_files_test(
        ...
        expected_outputs = [
            ...
            "app_clip_with_fmwks_from_objc_swift_libraries_using_data.app.dSYM/Contents/Resources/DWARF/app_clip_with_fmwks_from_objc_swift_libraries_using_data_arm64",
            "app_clip_with_fmwks_from_objc_swift_libraries_using_data.app.dSYM/Contents/Resources/DWARF/app_clip_with_fmwks_from_objc_swift_libraries_using_data_x86_64",
