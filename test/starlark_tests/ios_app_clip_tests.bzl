...
def ios_app_clip_test_suite(name):
    ...
    analysis_output_group_info_files_test(
        ...
        expected_outputs = [
            "app_clip_with_fmwks_from_objc_swift_libraries_using_data_dsyms/app_clip_with_fmwks_from_objc_swift_libraries_using_data.app.dSYM/Contents/Info.plist",
            "app_clip_with_fmwks_from_objc_swift_libraries_using_data_dsyms/app_clip_with_fmwks_from_objc_swift_libraries_using_data.app.dSYM/Contents/Resources/DWARF/app_clip_with_fmwks_from_objc_swift_libraries_using_data",
    ...
    apple_dsym_bundle_info_test(
        ...
        expected_direct_dsyms = [
            "dSYMs/app_clip_with_fmwks_from_objc_swift_libraries_using_data_dsyms/app_clip_with_fmwks_from_objc_swift_libraries_using_data.app.dSYM",
        ],
