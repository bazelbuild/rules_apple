...
def apple_static_xcframework_test_suite(name):
    ...
    infoplist_contents_test(
        ...
        target_under_test = "//test/starlark_tests/targets_under_test/apple:ios_static_xcframework_min_deployment_target",
        expected_values = {
            "AvailableLibraries:0:LibraryIdentifier": "ios-arm64",
            "AvailableLibraries:0:LibraryPath": "ios_static_xcframework_min_deployment_target.a",
            "AvailableLibraries:0:SupportedArchitectures:0": "arm64",
            "AvailableLibraries:0:SupportedPlatform": "ios",
            "AvailableLibraries:0:HeadersPath": "Headers",
            "AvailableLibraries:1:LibraryIdentifier": "ios-arm64_x86_64-simulator",
            "AvailableLibraries:1:LibraryPath": "ios_static_xcframework_min_deployment_target.a",
            "AvailableLibraries:1:SupportedArchitectures:0": "arm64",
            "AvailableLibraries:1:SupportedArchitectures:1": "x86_64",
            "AvailableLibraries:1:SupportedPlatform": "ios",
            "AvailableLibraries:1:SupportedPlatformVariant": "simulator",
    ...
    infoplist_contents_test(
        name = "{}_watchos_static_plist_test".format(name),
        target_under_test = "//test/starlark_tests/targets_under_test/apple:watchos_static_xcframework",
        expected_values = {
            "AvailableLibraries:0:LibraryIdentifier": "watchos-arm64_arm64_32",
            "AvailableLibraries:0:LibraryPath": "watchos_static_xcframework.framework",
            "AvailableLibraries:0:SupportedArchitectures:0": "arm64",
            ...
            "AvailableLibraries:1:LibraryPath": "watchos_static_xcframework.framework",
            "AvailableLibraries:1:SupportedArchitectures:0": "arm64",
            "AvailableLibraries:1:SupportedArchitectures:1": "x86_64",
    ...
    archive_contents_test(
        ...
        binary_test_file = "$BUNDLE_ROOT/ios-arm64_x86_64-simulator/ios_static_xcframework_min_deployment_target.a",
    ...
    archive_contents_test(
        name = "{}_watchos_x86_64_macho_load_cmd_for_simulator".format(name),
        build_type = "device",
        target_under_test = "//test/starlark_tests/targets_under_test/apple:watchos_static_xcframework",
        binary_test_architecture = "x86_64",
        binary_test_file = "$BUNDLE_ROOT/watchos-arm64_x86_64-simulator/watchos_static_xcframework.framework/watchos_static_xcframework",
        macho_load_commands_contain = [
            "cmd LC_BUILD_VERSION",
            "minos " + common.min_os_watchos.min_deployment_target,
    ...
    archive_contents_test(
        name = "{}_watchos_arm64_32_macho_load_cmd_for_device".format(name),
        build_type = "device",
        target_under_test = "//test/starlark_tests/targets_under_test/apple:watchos_static_xcframework",
        binary_test_architecture = "arm64_32",
        binary_test_file = "$BUNDLE_ROOT/watchos-arm64_arm64_32/watchos_static_xcframework.framework/watchos_static_xcframework",
        macho_load_commands_contain = [
            "cmd LC_BUILD_VERSION",
            "minos " + common.min_os_watchos.min_deployment_target,
            "platform WATCHOS",
    ...
    archive_contents_test(
        name = "{}_watchos_arm64_macho_load_cmd_for_simulator".format(name),
        build_type = "device",
        target_under_test = "//test/starlark_tests/targets_under_test/apple:watchos_static_xcframework",
        binary_test_architecture = "arm64",
        binary_test_file = "$BUNDLE_ROOT/watchos-arm64_x86_64-simulator/watchos_static_xcframework.framework/watchos_static_xcframework",
    ...
    archive_contents_test(
        name = "{}_watchos_arm64_macho_load_cmd_for_device".format(name),
        build_type = "device",
        target_under_test = "//test/starlark_tests/targets_under_test/apple:watchos_static_xcframework",
        binary_test_architecture = "arm64",
        binary_test_file = "$BUNDLE_ROOT/watchos-arm64_arm64_32/watchos_static_xcframework.framework/watchos_static_xcframework",
...
Please add a tvos attribute to the rule to declare the platforms to build for that OS.""",
    ...
    analysis_failure_message_test(
        ...
        expected_error = "Attempted to enable the secure feature `trivial_auto_var_init` for the target at `//test/starlark_tests/targets_under_test/apple:secure_features_ios_static_xcframework_with_rule_level_disabled_features`",
        tags = [name],
    )
    ...
    archive_contents_test(
        ...
        build_type = "device",
        target_under_test = "//test/starlark_tests/targets_under_test/apple:secure_features_ios_static_xcframework_with_trivial_auto_var_init",
        binary_test_file = "$BUNDLE_ROOT/ios-arm64/secure_features_ios_static_xcframework_with_trivial_auto_var_init.a",
        binary_test_architecture = "arm64",
        macho_load_commands_contain = ["cmd LC_BUILD_VERSION", "platform IOS"],
        tags = [name],
    )
    ...
    archive_contents_test(
        ...
        build_type = "device",
        target_under_test = "//test/starlark_tests/targets_under_test/ios:static_xcframework_with_public_hdrs",
        contains = [
            "$BUNDLE_ROOT/ios-arm64_arm64e/Headers/static_xcframework_with_public_hdrs/SharedClass.h",
            "$BUNDLE_ROOT/ios-arm64_x86_64-simulator/Headers/static_xcframework_with_public_hdrs/SharedClass.h",
        ],
        tags = [name],
    )
    ...
    archive_contents_test(
        ...
        build_type = "device",
        target_under_test = "//test/starlark_tests/targets_under_test/ios:static_xcframework_with_generated_public_hdrs",
        contains = [
            "$BUNDLE_ROOT/ios-arm64_arm64e/Headers/static_xcframework_with_generated_public_hdrs/SharedClass.h",
            "$BUNDLE_ROOT/ios-arm64_arm64e/Headers/static_xcframework_with_generated_public_hdrs/DummyFmwk.h",
            "$BUNDLE_ROOT/ios-arm64_x86_64-simulator/Headers/static_xcframework_with_generated_public_hdrs/SharedClass.h",
            "$BUNDLE_ROOT/ios-arm64_x86_64-simulator/Headers/static_xcframework_with_generated_public_hdrs/DummyFmwk.h",
        ],
        tags = [name],
    )
